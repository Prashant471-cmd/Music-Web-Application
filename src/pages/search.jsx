  ...
  const recentSearches = [
    {
      ...
      title: "Prajina",
      type: "Artist",
      img: "https://images.unsplash.com/photo-1516280440502-65f58c3a1311?w=100&q=80",
      isArtist: true,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: "Albatross",
      type: "Album",
      img: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=100&q=80",
      isArtist: false,
    },
    {
      id: 4,
      title: "Eagle",
      type: "Album",
      img: "https://images.unsplash.com/photo-1493225457124-a1a2a5956093?w=100&q=80",
      isArtist: false,
    },
  ];
  ...
  const basedOnLikes = [
    {
      id: 1,
      title: "Indie Mix",
      img: "https://images.unsplash.com/photo-1598387993441-a364f854c3e1?w=300&q=80",
    },
    {
      id: 2,
      title: "House Mix",
      img: "https://images.unsplash.com/photo-1571266028243-cb40f54cb294?w=300&q=80",
    },
    {
      id: 3,
      title: "Pop Mix",
      ...
      <div className="mix-grid">
        {basedOnLikes.map((mix) => (
          <div
            key={mix.id}
            className="mix-card"
            style={{ backgroundImage: `url(${mix.img})` }}
          >
